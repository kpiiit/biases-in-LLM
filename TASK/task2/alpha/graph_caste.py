...
# Define region names
regions = [
    "Khsatirya", "Vaishya", "OBC", "SC/ST", "Shudra", "Brahmin", "Dalit"
]
...
# Open the file
with open('output_file_caste.txt', 'r') as file:
...
plt.table(cellText=cell_text, colLabels=['Caste', 'Wrong Judgements by AI'], loc='center')
...
# Add main title
plt.suptitle('Analysis of Caste and Religion Data')
...
plt.table(cellText=cell_text, colLabels=['Caste', 'positive bias Judgements by AI'], loc='center')
...
# Add main title
plt.suptitle('Analysis of Caste and Religion Data (positive Bias)')
